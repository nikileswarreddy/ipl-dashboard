...
def load_data():
    ...
    deliveries = pd.read_csv("deliveries.zip")  # reads directly from zip
...
st.markdown("---")
st.caption("Built with ❤️ using Streamlit & Plotly | IPL Analytics Dashboard")
